...
export const FooterComponent = () => {
  return (
    <footer className="flex justify-center w-full h-16 mt-auto">
        <div className="flex w-4/5 justify-between items-center border-t-1 border-solid border-main-gray pt-2.5">
          <p className="font-bold text-gray-500">© {new Date().getFullYear()} Vbnb</p>
